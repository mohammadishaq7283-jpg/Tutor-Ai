...
<div class="container">
    ...
    <div id="screen-dashboard" class="screen">
        ...
        <p>Ask ANY educational question:</p>
    ...
    <div id="screen-chat" class="screen" style="padding: 0; display: none; flex-direction: column;">
        ...
        <div class="chat-input-area">
            <input type="text" id="user-msg" placeholder="Type here..." onkeypress="if(event.key==='Enter') sendMessage()">
...
<script>
    ...
    function startChat(subject) {
        ...
        if(currentLang.includes("Urdu") || currentLang.includes("Hindi")) greeting = `Salam/Namaste ${currentUser}!`;
    ...
    async function sendMessage() {
        ...
        try {
            ...
            if (e.name === 'AbortError') {
                document.getElementById(loadingId).innerText = "⚠️ Took too long. Ask shorter question.";
            } else {
